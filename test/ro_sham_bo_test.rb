...
class RoShamBoTest < Test::Unit::TestCase
  ...
  def test_cheater
    ...
    50.times do
      RoShamBo.new(cheater: :user).then do |game|
        game.play(%i[rock paper scissors].sample) until game.over?
    ...
    50.times do
      RoShamBo.new(cheater: :computer).then do |game|
        game.play(%i[rock paper scissors].sample) until game.over?
